...
const Landing = () => {
  ...
  const handleScroll = (direction) => {
    ...
    if (direction === "left") {
      ...
      setScrollPosition(
        Math.min(scrollPosition + container.offsetWidth, maxScroll)
      );
    }
  };
  ...
  return (
    <div className="relative">
      ...
      <div
        id="groundContainer"
        className="flex mx-4 sm:mx-16 my-8 overflow-x-auto justify-between relative">
        <div
