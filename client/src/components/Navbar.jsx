        ...
        <div className="flex justify-between items-center">
          ...
          <div className="lg:flex items-center justify-between text-lg gap-4">
            {isLogin && (
              <>
                <p
                  className="text-white font-medium cursor-pointer hidden lg:block"
                  onClick={() => {
                    navigate("/");
                  }}>
                  Home
          ...
          <div className="flex items-center">
            {!isLogin && (
              <button
                className="bg-white text-black font-bold px-4 py-2 rounded-md"
                onClick={handleLogin}>
                Login
              </button>
            )}
              ...
              <div className="mx-auto flex items-center justify-center bg-none rounded-md">
                <div className="group relative cursor-pointer">
                  <div className="flex items-center justify-between space-x-5 bg-none px-2 rounded-sm">
                    <a
                      className="menu-hover py-2 text-base font-medium text-white lg:mx-4"
                      onClick="">
                      Hi, {user}!
                    </a>
                    <span>
                  ...
                  <div className="invisible absolute z-50 flex w-full flex-col rounded-sm bg-gray-300 py-1 px-4 text-gray-800 shadow-xl group-hover:visible">
                    <a
                      className="my-2 block border-b border-black py-1 font-semibold text-gray-600 hover:text-gray-950 md:mx-2"
                      onClick={() => {
                        navigate("/bookings");
                      }}>
                      Bookings
