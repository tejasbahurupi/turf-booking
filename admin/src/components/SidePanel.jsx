  ...
  return (
    <div className="flex flex-col justify-between fixed inset-y-0 left-0 w-64 bg-green-700 text-white p-4">
      ...
      <ul className="space-y-2">
        ...
        <li>
          <Link to="/grounds" className="block py-2">
            Grounds
          </Link>
        </li>
        <li>
          <Link to="/create-ground" className="block py-2">
            Create Ground
          </Link>
        </li>
        <li>
      ...
      <div className="mt-auto mb-5">
        ...
        <button
          ...
          className="bg-white text-green-700 font-bold py-2 px-4 rounded-full block w-full mb-2">
          Logout
        </button>
      </div>
    </div>
